...
bool boundary_shapes()
{
  ...
  | A boundary color with value = 1 will be applied to all boundary
  | edges.
  ...
  | of which will get the boundary color with value = 2.
  ...
  | and a triangle. These will get the colors 3 and respectively, 
